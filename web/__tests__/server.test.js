...
describe("shopify-handlers-template-node server", async () => {
    ...
    test("redirects to auth if the handlers needs to be [re]installed", async () => {
    ...
    describe("content-security-policy", () => {
        ...
        test("sets header correctly when handlers is not embedded", async () => {
