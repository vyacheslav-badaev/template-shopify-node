...
/**
 * You may want to charge merchants for using your handlers. This helper provides that function by checking if the current
...
async function requestRecurringPayment(
    client,
    returnUrl,
    {chargeName, amount, currencyCode, interval, trialDays = 0}
) {
